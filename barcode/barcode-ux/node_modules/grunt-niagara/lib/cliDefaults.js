...
module.exports = function (grunt) {
  ...
  return {
    ...
    /** no Chrome flags */
    'chrome-flags': '',
    /** path to Grunt options override file */
    'options': path.resolve(niagaraUserHome) + '/etc/my-grunt-options.json',
    /** path to Grunt config override file */
    'config': path.resolve(niagaraUserHome) + '/etc/my-grunt-config.json',
    /** whether to skip the full transpile on startup */
    'quick-start': 'false'
  };
};

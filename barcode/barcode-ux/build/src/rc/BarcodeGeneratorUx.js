define(['baja!', 'jquery', 'nmodule/webEditors/rc/fe/baja/BaseEditor', 'Promise', 'nmodule/webEditors/rc/util/htmlUtils', 'bajaux/mixin/subscriberMixIn'], function (baja, $, BaseEditor, Promise, htmlUtils, subscriberMixIn) {
  'use strict';
